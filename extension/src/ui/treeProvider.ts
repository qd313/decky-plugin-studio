  ...
  getChildren(element?: DeckyTreeItem): DeckyTreeItem[] {
    ...
    return [
      ...
      new DeckyTreeItem("── MCP tools ──", vscode.TreeItemCollapsibleState.Expanded, [
        ...
        tool("deck.reloadPlugin"),
        tool("deck.openPlugin"),
        tool("deck.readPluginLog"),
        tool("deck.readFocus"),
        tool("deck.pressButton"),
        tool("deck.pressChord"),
        tool("deck.launchGame"),
        tool("deck.exitGame"),
        tool("deck.assertFocusMove"),
        tool("deck.getEnv"),
        tool("deck.deploy"),
        tool("plugin.build"),
        ...
        tool("preview.compareScreenshot"),
        tool("preview.tailEmit"),
